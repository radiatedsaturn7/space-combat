...
public class PrefabFactory 
{
	...
	public static GameObject createPhaser (Vector3 position, Vector3 speed, String [] tags, InputStream is, float damage, int power, float life)
	{
		//Load the texture for the cube once during Surface creation
		GenericGraphic graphic = createGraphic("phaser", is);
	...
	public static GameObject createEnemy (String name, Vector3 position, InputStream is, InputStream is2, int enemyType, int scriptType)
	{
		...
		if (enemyType == 1)
		{
			Weapon w = new Phaser(shootDown,is2,4);
		...
		if (enemyType == 2)
		{
			Weapon w = new Phaser(shootDown,is2,3);
			WeaponHandler wh = new WeaponHandler(w);
		...
		{
			Weapon w = new Phaser(shootLeft,is2,4);			
			WeaponHandler wh = new WeaponHandler(w);
			
			Weapon w2 = new Phaser(shootDownLeft,is2,4);			
			WeaponHandler wh2 = new WeaponHandler(w2);
			
			Weapon w3 = new Phaser(shootDown,is2,4);			
			LockingWeaponHandler wh3 = new LockingWeaponHandler(w3,enemyTargets);
			
			Weapon w4 = new Phaser(shootDownRight,is2,4);			
			WeaponHandler wh4 = new WeaponHandler(w4);
			
			Weapon w5 = new Phaser(shootRight,is2,4);	
