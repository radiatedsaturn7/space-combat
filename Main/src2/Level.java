...
public class Level {
	...
	*/
	...
	public void AddEnemy(int kind, int script, Point pos, boolean Reverse, boolean TravelDown)
	{
		ScriptedShip m2 = new ScriptedShip(new Point(pos), new Point(32,32), Util.m_imEnemyImage ,1, true, true);
			...
			Animation a = new Animation("IDLE", (kind*8-1),(kind*8),false,2);
			AnimationList.add(a);
			a = new Animation("DIE",((kind-1)*8)+1,(kind*8-2),false,3);
			AnimationList.add(a);
