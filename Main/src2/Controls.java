...
public class Controls
{
	...
	public static void HandleControls()
	{
		for (int x = 0; x < Util.m_iNumOfPlayers; x++)
		{
			...
			//	Sprite s = (Sprite)(Util.m_alSprite.get(x));
				Shot sh = new Shot(new Point(S.m_rcBoundingBox.x, S.m_rcBoundingBox.y),new Point(32,32),Util.m_imShotImage, 1, false, false);
					...
					sh.PlayAnimation("PRINT");
						...
						sh.m_pSpeed.x = S.m_pSpeed.x;
						sh.m_rcBoundingBox.y -= 37;
						sh.m_pSpeed.y = -16 + S.m_pSpeed.y;
