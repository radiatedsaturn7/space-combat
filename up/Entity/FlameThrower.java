...
public class FlameThrower extends Weapon {
	public FlameThrower(String name, int damage, int damage2, int owner)
	{
	...
	public void Shoot(Point Position, Point Speed, int Faction, Time Life)
	{
		...
		Shot sh = new Shot(new Point(Position),new Point(32,32),Util.m_imFlameImage, 1, m_iOwner, false, false);
		sh.AddImage(Util.m_imFlameImageNV);
