public class Time
{
	...
	public static Time AddTime(Time t, Time t2)
	{
		Time Ret = new Time(t);
		Ret.m_iMilliseconds += t2.m_iMilliseconds;
		Ret.m_iSeconds += t2.m_iSeconds;
		Ret.m_iMinutes += t2.m_iMinutes;
		Ret.m_iHours += t2.m_iHours;
		Ret.m_iDays += t2.m_iDays;
		Ret.m_iYears += t2.m_iYears;
		Ret.Update();
		return Ret;
	}
	public void Update()
