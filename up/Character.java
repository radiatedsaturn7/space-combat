...
public class Character extends Sprite
{
	...
	public Character(Character c)
	{
		...
		m_iHealth = c.m_iMaxHealth;
		m_iMagic = c.m_iMagic;
		m_iMaxMagic = c.m_iMaxMagic;
	...
	public void CollideWith (Sprite S)
	{
		...
		if (S.m_iFaction == m_iFaction || m_iHealth < 0)
		{
					return;
		}
		if (S instanceof Shot)
		{
			...
			//System.out.println("HIT:"+((Shot)(S)).m_iShotFrom+" "+m_iHealth);
			if (m_iHealth<=0)
			{
				//System.out.println(((Shot)(S)).m_iShotFrom);
				if (((Shot)(S)).m_iShotFrom == 1 && Util.m_iSetup[1] != 8)
				{
					((Character)(Sprite)(Util.m_alSprite.get(0))).m_iScore += m_iMaxHealth/10;
					((Character)(Sprite)(Util.m_alSprite.get(0))).m_iBonus += m_iMaxHealth;
					Util.m_iKills[0]++;
				}
				else if (((Shot)(S)).m_iShotFrom == 2 && Util.m_iSetup[4] != 8)
				{
					((Character)(Sprite)(Util.m_alSprite.get(1))).m_iScore += m_iMaxHealth/10;
					((Character)(Sprite)(Util.m_alSprite.get(1))).m_iBonus += m_iMaxHealth;
					Util.m_iKills[1]++;
				}
				else if (((Shot)(S)).m_iShotFrom == 2 || ((Shot)(S)).m_iShotFrom == 1)
				{
					((Character)(Sprite)(Util.m_alSprite.get(0))).m_iScore += m_iMaxHealth/10;
					((Character)(Sprite)(Util.m_alSprite.get(0))).m_iBonus += m_iMaxHealth;
					Util.m_iKills[((Shot)(S)).m_iShotFrom-1]++;
				}
			}
			S.m_bDelete = true;
		}
		...
		{
			if ((m_bIsPlayer || this instanceof AllyShip))
			{
				if (((PowerUp)(S)).m_iType == 0 && m_wWeapon.m_iPowerLevel < m_wWeapon.m_iMaxPowerLevel)
				{
					m_wWeapon.m_iPowerLevel++;
				}
				if (((PowerUp)(S)).m_iType == 2&& m_wWeapon.m_iPowerLevel < m_wWeapon.m_iMaxPowerLevel2)
				{
					m_wWeapon.m_iPowerLevel2++;
					m_wWeapon.m_tMissileReloadTime = new Time();
					m_wWeapon.m_tMissileReloadTime.AddMilliseconds(1000 - (m_wWeapon.m_iPowerLevel * 30));
					m_wWeapon.m_tMissileReloadTime.Update();
				}
				if (((PowerUp)(S)).m_iType == 1 && m_iHealth < m_iMaxHealth)
				{
